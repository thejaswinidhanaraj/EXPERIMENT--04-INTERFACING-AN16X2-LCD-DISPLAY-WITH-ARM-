...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
      ...
      Lcd_cursor(&lcd, 0,1);
      Lcd_string(&lcd, "Thejaswini");
      Lcd_cursor(&lcd, 1,1);
      Lcd_string(&lcd, "212223110059");
...
## Output screen shots of proteus  :
 ...
 ![Screenshot 2024-09-30 142251](https://github.com/user-attachments/assets/a8dddbcd-893f-46d3-81a0-444f7ce26c8a)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 ![exp3-layout](https://github.com/user-attachments/assets/3c91f0d0-7d72-4f66-a328-3dbaa25991a0)
